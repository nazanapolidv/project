...
/**
 * Tareas disponibles para el usuario. Lista las tareas reales en una JTable
 * y permite subir una evidencia para la tarea seleccionada, delegando la
 * persistencia en EvidenciaDAO (patrón DAO).
 */
