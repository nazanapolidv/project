...
/**
 * Helper de interfaz: centraliza la paleta de colores, la tipografía y las
 * "fábricas" de componentes (botones, etiquetas, campos, tablas) para que
 * todas las ventanas de EcoTrack tengan un estilo consistente y el código
 * de cada JFrame quede corto y legible.
 */
public final class UI {

    private UI() { } // clase de utilidades: no se instancia
    ...
    // --------------------------- Frame base ---------------------------
    /** Tamaño, centrado, fondo e ícono comunes a todas las ventanas. */
    ...
    /** Cabecera verde con título y subtítulo, para colocar en BorderLayout.NORTH. */
    ...
    /** Panel de contenido con padding y fondo claro. */
    ...
    // ----------------------------- Tablas -----------------------------
    /** Modelo de tabla de solo lectura (las celdas no se editan a mano). */
    ...
    /** Aplica el estilo EcoTrack a una JTable y la devuelve dentro de un JScrollPane. */
