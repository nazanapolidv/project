...
public class CanjearPuntosFrame extends JFrame {
    ...
    private final PremioDAO premioDAO = new PremioDAOImpl();
    ...
    private void cargarPremios() {
        ...
        premios = premioDAO.listarPremios();
    ...
    private void actualizarSaldo() {
        int puntos = usuarioDAO.obtenerPuntosUsuario(idUsuario);
    ...
    private void canjear() {
        ...
        int saldo = usuarioDAO.obtenerPuntosUsuario(idUsuario);
        ...
        if (usuarioDAO.reducirPuntosUsuario(idUsuario, costo)) {
            JOptionPane.showMessageDialog(this,
