...
/**
 * Dashboard del administrador: tarjetas con los indicadores principales
 * (usuarios, tareas activas, evidencias pendientes, eventos próximos) y una
 * JTable con el desglose de evidencias pendientes por eje temático.
 */
public class DashboardFrame extends JFrame {
    ...
    public DashboardFrame() {
        ...
        DashboardDLL dash = new DashboardDLL();
    ...
    private JPanel construirTarjetas(DashboardDLL dash) {
    ...
    private JPanel construirTablaEjes(DashboardDLL dash) {
